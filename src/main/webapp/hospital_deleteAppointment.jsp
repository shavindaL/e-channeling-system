    ...
    <main>
        ...
        <ul class="nav flex-column nav-pills">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle active sidebar-link" data-bs-toggle="dropdown" href=""><i class="fa-solid fa-calendar-check"></i></i> Session</a>
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="hospital_newAppointment.jsp">New Session</a></li>
              <li><a class="dropdown-item active" href="viewAppt">View Session</a></li>           
            </ul>
          </li>
          <li class="nav-item">
        ...
        <div class="region-main">
            <div class="row">
                <h1 class="">Delete Session</h1>
                <form class="row g-3 needs-validation" method="post" action="delete">
                    <div class="col-md-4">
                        <label for="docId" class="form-label">Appointment ID</label>
                        <input type="text" class="form-control" name="apptId" value="<%= apptId %>" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="docId" class="form-label">Doctor ID</label>
                        <input type="text" class="form-control" name="docId" value="<%= docId %>" readonly>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="startTime" value="<%= sTime %>" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="endTime" class="form-label">End Time</label>
                        <input type="text" class="form-control" name="endTime" value="<%= eTime %>" readonly>
                    </div>
                    <div class="col-12">
                        <button class="btn btn-primary" type="submit">Delete Session</button>
                    </div>
                </form>
            </div>
        </div>
