...
<body>
    ...
    <main>
        ...
        <ul class="nav flex-column nav-pills">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item active" href="hospital_newAppointment.jsp">New Session</a></li>
        ...
        <div class="region-main">
            <div class="row">
                <h1 class="">Create New Session</h1>
                <form class="row g-3 needs-validation" method="post" action="insert">
                    <div class="col-md-3">
                        <label for="docId" class="form-label">Doctor ID</label>
                        <input type="text" class="form-control" name="docId" placeholder="D000" required>
                    </div>
