    ...
    <main>
        <div class="row">
            <div class="col-2 sidebar">
                ...
                <ul class="nav flex-column nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link sidebar-link" href="hospital_profile.jsp"><i class="fa-solid fa-user"></i>
                            Profile</a>
                    </li>
        ...
        <div class="region-main">
            <div class="row">
                ...
                <form class="row g-3 needs-validation" method="post" action="updateAppointment">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="startTime" value="<%=sTime %>">
                    </div>
                    <div class="col-md-4">
                        <label for="endTime" class="form-label">End Time</label>
                        <input type="text" class="form-control" name="endTime" value="<%=eTime %>">
                    </div>
                    <div class="col-12">
